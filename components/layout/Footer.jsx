              ...
              <ul className="space-y-4 mt-4">
                ...
                <li className="flex gap-3">
                  ...
                  <a
                    ...
                    className="text-gray-400 hover:text-arc-gold text-sm transition-colors duration-200"
                  >
                    0092-41-8755112
                  </a>
                </li>
              ...
              <ul className="space-y-4 mt-4">
                ...
                <li className="flex gap-3">
                  ...
                  <a
                    ...
                    className="text-gray-400 hover:text-arc-gold text-xs transition-colors duration-200 break-all"
                  >
      ...
      <div className="border-t border-white/10 py-6">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-gray-500 text-sm">
            © {new Date().getFullYear()} Ahmad Rafique Construction Company Pvt.
            Ltd. All rights reserved.
          </p>
          <p className="text-gray-600 text-xs">NTN: {companyInfo.ntn}</p>
        </div>
      </div>
    </footer>
  );
